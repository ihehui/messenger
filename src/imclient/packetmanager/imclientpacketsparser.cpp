...
void IMClientPacketsParser::parseIncomingPacketData(const PacketBase &packet)
{
    ...
    case quint8(IM::CMD_OnlineStateChanged): {
        ...
        emit signalContactStateChangedPacketReceived(contactID, stateCode, contactIP, contactPort);
