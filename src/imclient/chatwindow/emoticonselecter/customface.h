...
public:
    ...
    {
        return OrgName;    // original name, md5+extension
    }
    ...
    {
        return FramesCount;    // number of frames
    }
    /*const*/ int groupID()  const
    {
        return GroupId;    // groupID id of this custom smiley
    }
